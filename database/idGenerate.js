...
function generatePoliceStationId() {
    return generateId('PS', 'policeOfficer', 'policeStationId');
}

function generatePoliceOfficerId() {
    return generateId('PO', 'police_officer', 'officerId');
}

// Example usage:
const newStationId = generatePoliceStationId();
console.log("New Police Station ID:", newStationId); // e.g., "PS00001"

const newOfficerId = generatePoliceOfficerId();
console.log("New Police Officer ID:", newOfficerId); // e.g., "PO00001"
